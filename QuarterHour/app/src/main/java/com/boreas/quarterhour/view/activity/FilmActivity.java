...
public class FilmActivity extends BaseActivity  implements SurfaceHolder.Callback  {
    ...
    protected void initView() {
        ...
        mBtnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer = MediaPlayer.create(FilmActivity.this, uri);
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        if (mRecorder != null) {
            mRecorder.release();
            mRecorder = null;
            Log.e("", "surfaceDestroyed release mRecorder");
        }
        if (camera != null) {
            camera.release();
            camera = null;

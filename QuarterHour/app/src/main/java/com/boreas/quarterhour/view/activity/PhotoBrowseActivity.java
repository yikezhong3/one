...
import com.boreas.quarterhour.utils.widget.BaseAnimCloseViewPager;
...
public class PhotoBrowseActivity extends AppCompatActivity {
    ...
    public static void startWithElement(Activity context, ArrayList<String> urls, int firstIndex, View view) {

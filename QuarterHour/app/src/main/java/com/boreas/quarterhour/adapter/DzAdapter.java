...
import com.boreas.quarterhour.DZXaingqingActivity;
...
public class DzAdapter extends RecyclerView.Adapter<DzAdapter.IHoldView> {
    Context context;
    List<DZBean.DataBean> dzBean;
    public DzAdapter(Context context, List<DZBean.DataBean> dzBean) {
    ...
    public void onBindViewHolder(IHoldView holder, int position) {
       ...
       holder.itemView.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               Intent intent = new Intent(context, DZXaingqingActivity.class);
